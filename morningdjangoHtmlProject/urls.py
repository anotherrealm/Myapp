"""
URL configuration for morningdjangoHtmlProject project.
...
urlpatterns = [
    ...
    path('delete-product/<id>', user_views.delete_product, name='del-product'),
    path('update-product/<id>', user_views.update_product, name='upd-product'),
    path('register/', user_views.register_me, name='user-registration'),
    path('login/', auth_views.LoginView.as_view(template_name='login.html'), name="user_login"),
    path('log-out/', auth_views.LogoutView.as_view(template_name='logout.html'), name="user_logout"),
